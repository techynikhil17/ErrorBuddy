...
export declare function formatErrorOutput(explained: ExplainedError, normalized: NormalizedError, classified: ClassifiedError, fixes: string[], verbose?: boolean): string;
export declare function formatSuggestionOutput(input: string, suggestion: SuggestionMessage): string;
export declare function formatUnknownErrorOutput(rawLines: string): string;
